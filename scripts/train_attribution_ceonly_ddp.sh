#!/usr/bin/env bash
# UNITE E2 CE-only attribution run (8-way DDP, one process per GPU).
set -euo pipefail

# ---------------- editable settings ----------------
GPUS="0,1,2,3,4,5,6,7"
CONFIG="configs/unite_ffpp_c23_e2_ceonly.yaml"
RUN_NAME="e2_ceonly"
RESUME="/home/tangbo/code/projects/UNITE/outputs/ffpp_c23/e1_balanced/siglip-so400m-patch14-384_d4_h12/img384_nf64_stride2/ce0.5_ad0.5/lr0.0001_effbs32_gc1_amp0/e1_balanced/latest_train.ckpt"
PORT_START=29500
NCCL_TIMEOUT=1800
LOG_DIR="logs"
# ----------------------------------------------------
